...
def api_iphone_samsung_details():
    ...
    df= pd.read_csv('C:\\Users\dharm\Desktop\Amazon_Data_Visualizations-main\Cleaned Data\iphone_samsung_merged_data.csv')
...
def api_iphone_details():
    ...
    df= pd.read_csv('C:\\Users\dharm\Desktop\Amazon_Data_Visualizations-main\Cleaned Data\iphone_cleaned_data.csv')
    df1=df.to_json(orient='records')
    df1=pd.read_json(df1)
...
def api_samsung_details():
    ...
    df = pd.read_csv('C:\\Users\dharm\Desktop\Amazon_Data_Visualizations-main\Cleaned Data\samsung_cleaned_data.csv')
    df1=df.to_json(orient='records')
    df1=pd.read_json(df1)
